 ...
 *
 * Note: Use the verbose flag for outputting game information. Use the fast flag
 * for using 100ms move deadline instead of 1000ms. Use the init flag if you
 * want this client to initialize the game, that is, send a starting board
 * without moving for the other client to move first.
 */
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        /**
         * Start the game by sending the starting board without moves if the
         * parameter "init" is given
         */
        if (init) {
        ...
        while ((input_message = br.readLine()) != null) {
            ...
            if (verbose) {
                System.err.println("INPUT STATE");
            ...
            if (verbose) {
                System.err.println("OUTPUT STATE");
